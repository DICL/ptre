#ifndef PTRE_COMMON_CM_PEER_SELECTOR_H_
#define PTRE_COMMON_CM_PEER_SELECTOR_H_
...
class DivNRoundRobinV2 : public PeerSelectorInterface {
 public:
  DivNRoundRobinV2(int comm_size, int comm_rank, int num_comm);
  int get_peer() override;
...
#endif  // PTRE_COMMON_CM_PEER_SELECTOR_H_
