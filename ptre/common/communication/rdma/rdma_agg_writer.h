#ifndef PTRE_COMMON_COMMUNICATION_RDMA_RDMA_AGG_WRITER_H_
#define PTRE_COMMON_COMMUNICATION_RDMA_RDMA_AGG_WRITER_H_
...
#endif  // PTRE_COMMON_COMMUNICATION_RDMA_RDMA_AGG_WRITER_H_
