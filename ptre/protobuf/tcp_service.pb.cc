...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_tcp_5fservice_2eproto[2];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_tcp_5fservice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::ptre::PushTensorRequest, name_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::ptre::PushTensorRequest)},
  { 8, -1, sizeof(::ptre::PushTensorResponse)},
};
...
const char descriptor_table_protodef_tcp_5fservice_2eproto[] =
  ...
  "equest\022\020\n\010src_rank\030\001 \001(\005\022\014\n\004name\030\002 \001(\t\022\013"
  "\n\003buf\030\003 \001(\014\"K\n\022PushTensorResponse\022\020\n\010dst"
  "_rank\030\001 \001(\005\022\023\n\013tensor_name\030\002 \001(\t\022\016\n\006stat"
  "us\030\003 \001(\0052F\n\003Tcp\022\?\n\nPushTensor\022\027.ptre.Pus"
  "hTensorRequest\032\030.ptre.PushTensorResponse"
  "b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_tcp_5fservice_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_tcp_5fservice_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tcp_5fservice_2eproto = {
  &descriptor_table_tcp_5fservice_2eproto_initialized, descriptor_table_protodef_tcp_5fservice_2eproto, "tcp_service.proto", 248,
  &descriptor_table_tcp_5fservice_2eproto_once, descriptor_table_tcp_5fservice_2eproto_sccs, descriptor_table_tcp_5fservice_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_tcp_5fservice_2eproto::offsets,
  file_level_metadata_tcp_5fservice_2eproto, 2, file_level_enum_descriptors_tcp_5fservice_2eproto, file_level_service_descriptors_tcp_5fservice_2eproto,
};
...
const int PushTensorRequest::kNameFieldNumber;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_name(), ptr, ctx, "ptre.PushTensorRequest.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // bytes buf = 3;
